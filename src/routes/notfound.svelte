<script lang="ts">
	...
	let visor: HTMLCanvasElement;
	let cord: HTMLCanvasElement;
...
<div class="error">
	...
	<a href="/">
		<button class="error__button error__button--active">Return Home</button>
	</a>
</div>
...
<div class="astronaut">
	...
	<div class="astronaut__cord">
		<canvas height="500px" width="500px" bind:this={cord}></canvas>
	</div>

	<div class="astronaut__head">
		<canvas width="60px" height="60px" bind:this={visor}></canvas>
...
<style>
	...
	.astronaut__foot-left {
		...
		border-top-left-radius: 8em;
		border-top-right-radius: 8em;
		border-bottom: 4px solid #7909e2;
	}
